...
lt_x64_register_t regs[REG_COUNT] = {
	...
	{ CLSTRI("r8"), { CLSTRI("r8b"), CLSTRI("r8d"), CLSTRI("r8w"), CLSTRI("r8") } },
	{ CLSTRI("r9"), { CLSTRI("r9b"), CLSTRI("r9d"), CLSTRI("r9w"), CLSTRI("r9") } },
	{ CLSTRI("r10"), { CLSTRI("r10b"), CLSTRI("r10d"), CLSTRI("r10w"), CLSTRI("r10") } },
	{ CLSTRI("r11"), { CLSTRI("r11b"), CLSTRI("r11d"), CLSTRI("r11w"), CLSTRI("r11") } },
	{ CLSTRI("r12"), { CLSTRI("r12b"), CLSTRI("r12d"), CLSTRI("r12w"), CLSTRI("r12") } },
	{ CLSTRI("r13"), { CLSTRI("r13b"), CLSTRI("r13d"), CLSTRI("r13w"), CLSTRI("r13") } },
	{ CLSTRI("r14"), { CLSTRI("r14b"), CLSTRI("r14d"), CLSTRI("r14w"), CLSTRI("r14") } },
	{ CLSTRI("r15"), { CLSTRI("r15b"), CLSTRI("r15d"), CLSTRI("r15w"), CLSTRI("r15") } },
};
